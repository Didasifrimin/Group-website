...
local_css("C:/Users/admin/Desktop/Group website/style/style.css.txt")
#-----load assets----
lottie_coding=load_lottieurl("https://assets6.lottiefiles.com/packages/lf20_1LhsaB.json")
img_contact_form=Image.open("C:/Users/admin/Desktop/Group website/images/didaimg2.png")
img_lottie_animation=Image.open("C:/Users/admin/Desktop/Group website/images/prisca2.png")
img_contact_ibra=Image.open("C:/Users/admin/Desktop/Group website/images/ibrah2.png")
img_lottie_amon=Image.open("C:/Users/admin/Desktop/Group website/images/amon1.png")
img_lottie_christina=Image.open("C:/Users/admin/Desktop/Group website/images/christina.png")
...
with st.container():
    ...
    with text_column:
        ...
        st.markdown("[click here..](https://twitter.com/physics_special)")
